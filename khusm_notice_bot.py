...
title_latest_list = [board_newest_post(url_list[0], css_selector),
                board_newest_post(url_list[1], css_selector),
                board_newest_post(url_list[2], css_selector),
                board_newest_post(url_list[3], css_selector)]
...
while True:
    for i in range(len(url_list)):
        if i == 0:
            ...
            board_category = "일반"
        title = board_newest_post(url_list[i], css_selector)
